...
namespace TrackerWeb {
    public abstract class Serializable : GLib.Object, Json.Serializable {
        ...
        public virtual Json.Node serialize_property (string property_name, Value @value, ParamSpec pspec) {
            ...
            // } else if (@value.type ().is_a (typeof (Method))) {
            //     var node = new Json.Node (Json.NodeType.VALUE);
            //     node.set_string (((Method) value).to_string ());
            //     return node;
            }
        ...
        public virtual bool deserialize_property (string property_name, out Value @value, ParamSpec pspec, Json.Node property_node) {
            // if (pspec.value_type.is_a (typeof (Method))) {
            //     @value = Method.from_string (property_node.get_string ());
            //     return true;
            // }
